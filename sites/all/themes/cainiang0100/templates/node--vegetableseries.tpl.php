        ...
        <div id="product_content">
	      ...
	      // We hide the comments and links now so that we can render them later.
              ...
              // print render($content['product:commerce_price']['#object']->commerce_price['und'][0]['amount']);
               $amount['#access']= 'TRUE';
              //$amount[0]['#markup'] = trim(commerce_currency_format($content['product:commerce_price']['#object']->commerce_price['und'][0]['amount'], 'CNY'),'?').'元/公斤p';
              $amount['#printed'] = 'TRUE';
              //dsm($content['field_product_reference']);
              //$content['field_product_reference'][0]['quantity']['#title']='公斤';
              //$content['field_product_reference'][0]['quantity']['#title_display']='after';
              //$content['field_product_reference'][0]['submit']['#value']='加入菜篮子';
                print render($amount);
              //dsm($node);
