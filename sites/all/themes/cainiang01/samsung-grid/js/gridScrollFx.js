...
;( function( window ) {
	...
	//var docElem = window.document.documentElement,
	    var docElem = document.getElementById("page"),//.scrollTop,
	...
	GridScrollFx.prototype._init = function() {
		...
		imagesLoaded( this.el, function() {
			...
			var onScrollFn = function() {
			    //console.log('onScrollFn：',self.itemsRenderedCount);
				if( !self.didScroll ) {
					self.didScroll = true;
				...
				if( self.itemsRenderedCount === self.itemsCount ) {
				    //console.log('window.removeEventListener self.itemsRenderedCount：',self.itemsRenderedCount);
					window.removeEventListener( 'scroll', onScrollFn, false );
				}
			}
            var onScrollFnTest = function() {
			    //console.log('onScrollFn：',self.itemsRenderedCount);
				//console.log('scrollY()：',scrollY());
				}
			//docElem.addEventListener( 'scroll', onScrollFnTest, false );
			// animate the items inside the viewport (on scroll)
			docElem.addEventListener( 'scroll', onScrollFn, false );
	...
	GridScrollFx.prototype._resizeHandler = function() {
		...
		function delayed() {
			...
			//alert(document.getElementById("grid").parentNode.clientWidth);
